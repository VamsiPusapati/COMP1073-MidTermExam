...
var travelReport = (function () {
	...
	// Injecting the IntroParagraph to the index.html
	var IntroParagraph;
	...
	// Injecting the Folegandros to the index.html
	var Folegandros;
	...
	// Injecting the Alonissos to the index.html
	var Alonissos;
	...
	// Injecting the Spetses to the index.html
	var Spetses;
	...
	// Injecting the Amorgos to the index.html
	var Amorgos;
	...
	// Injecting the Syros to the index.html
	var Syros;
	...
	// Injecting the Milos to the index.html
	var Milos;
	...
	// Injecting the Hydra to the index.html
	var Hydra;
	...
	// Injecting the Ithaca to the index.html
	var Ithaca;
	...
	// Injecting the Gavdos to the index.html
	var Gavdos;
	...
	//declare variables and create a reference to the form elements
